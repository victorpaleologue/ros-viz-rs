...
- Rendering resolution is user-configurable via CLI (width/height); defaults favor reproducibility (800x600) for tests.
...
- Emulator and URDF paths will share fixture assets under `assets/tests/urdf` for consistency and speed.
