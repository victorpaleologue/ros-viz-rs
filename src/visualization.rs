...
pub fn spawn_robot_from_urdf(
    ...
    spawn_robot_from_urdf_with_geometry(commands, scene, meshes, materials, RobotGeometry::default())
}
...
pub fn spawn_robot_from_urdf_with_geometry(
    ...
    let link_mesh = meshes.add(Cuboid::new(geometry.link_size.0, geometry.link_size.1, geometry.link_size.2));
    ...
    let child_links: std::collections::HashSet<_> = scene
        .joints
        .iter()
